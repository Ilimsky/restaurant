...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.example.restaurant.repositories.*Repo.*(..))", throwing = "exception")
	public void logExceptionFromDAO(Exception exception) throws Exception {
		log(exception);
	}
	
	@AfterThrowing(pointcut = "execution(* com.example.restaurant.services.*Impl.*(..))", throwing = "exception")
